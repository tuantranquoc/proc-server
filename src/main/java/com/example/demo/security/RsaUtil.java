...
public class RsaUtil {
    ...
    public static byte[] encrypt(String data, String publicKey) throws BadPaddingException, NoSuchAlgorithmException,
    ...
    public static String decrypt(String data, String base64PrivateKey)
            throws BadPaddingException, NoSuchAlgorithmException, IllegalBlockSizeException, NoSuchPaddingException,
